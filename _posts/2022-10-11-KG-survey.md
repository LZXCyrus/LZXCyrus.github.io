...
Definition :
$$\{ T_0,T_1,...,T_L \} \quad (a \quad set \quad of \quad texts)\\ including \quad \{ tp_0,...,tp_\tau \} (all \quad event \quad types)\\ \{ rl_0^i,...,rl_p^i \} \quad (all \quad argument \quad roles \quad for \quad each \quad event \quad type \quad tp_i)$$
...
$$
G=\{ (s,p,o) \mid \{ s,p \} \in N,p \in E, N=N_evt \bigcup N_ent, E=E_{evt-evt} \bigcup E_{evt-ent}} \bigcup E_{ent-ent} \}
$$
